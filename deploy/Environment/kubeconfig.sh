...
export AWS_S3_BUCKET=scaledmarkets-kubernetes-artifacts
export KUBE_AWS_INSTANCE_PREFIX=SafeHarborKube
export AWS_SSH_KEY=/Users/cliffordberg/Documents/ScaledMarkets/SafeHarbor/SafeHarborServer/deploy/AWS/SafeHarborServer
export KUBE_OS_DISTRIBUTION=jessie
export KUBE_NODE_IMAGE=ami-61bbf104
